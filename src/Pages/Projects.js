            ...
            <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-branding sorting-photo">
              <div className="works-item">
                <Link to="work-single.html">
                  ...
                  >
                    <span className="img">
                      <img src="./assets/images/images-work4.jpg" alt="Zorro" />
            ...
            <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-branding sorting-ui-ux-design">
              <div className="works-item">
                <Link to="work-single.html">
                  ...
                  >
                    <span className="img">
                      <img src="./assets/images/images-work2.jpg" alt="Gooir" />
                      <span className="overlay" />
                    </span>
                  </span>
                  <span className="desc">
            ...
            <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-development sorting-ui-ux-design">
              <div className="works-item">
                <Link to="work-single.html">
                  ...
                  >
                    <span className="img">
                      <img src="./assets/images/images-work7.jpg" alt="Explore" />
                      <span className="overlay" />
                    </span>
                  </span>
                  <span className="desc">
            ...
            <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-branding sorting-photo">
              <div className="works-item">
                <Link to="work-single.html">
                  ...
                  >
                    <span className="img">
                      <img src="./assets/images/images-work1.jpg" alt="Mozar" />
                      <span className="overlay" />
                    </span>
                  </span>
                  <span className="desc">
            ...
            <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-branding sorting-photo">
              <div className="works-item">
                <Link to="work-single.html">
                  ...
                  >
                    <span className="img">
                      <img src="./assets/images/images-single6.jpg" alt="Kana" />
                      <span className="overlay" />
                    </span>
                  </span>
                  <span className="desc">
